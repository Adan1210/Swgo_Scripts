...
for j in list_energies
    for i in 1:3
        path                     = "/home/adan1210/Documents/Proofs/swgo_scripts/particle1_$(j)_to_$(j)GeV_0_to_0degrees_A1_Yanque/rec_energy_Aerie_$(i)shower_particle1_$(j)_to_$(j)GeV_0_to_0degrees_A1_Yanque.root"
...
plot(
    ...
    list_energy_bias,
    xlim=(minimum(list_energies)[1]/1.1,maximum(list_energies)[end]*1.1),              #limits of x axis
    ylim=(-0.16,-0.04),
    xticks=[10^exp for exp in (3:0.5:4)],
    yticks=(-0.15:0.05:-0.05),                                         #limits of y axis
    ...
    gridlinewidth=2, gridalpha=0.2,                                #grid and width
    xlabel="Primary Energy (GeV)",                                 #label of x axis
    ylabel="Energy bias",                                          #label of y axis
    linestyle=:solid, linewidth=0.5,                               #type of line
    marker=:circle, markercolor=:red, markersize=2,                #marker and size
    markerstrokecolor=:black, markerstrokewidth=0.1,               #contour of the marker
    titlefont=font,
    guidefont=font,
    legendfont=font,
    dpi=500)                                                                  #resolution for the figure
# Save the figure
file_name = "/home/adan1210/Documents/Proofs/swgo_scripts/swgo_plots/energy_bias.svg"
savefig(file_name)
...
plot(
    ...
    xlim=(list_energies[1]/1.1,list_energies[end]*1.1),                    #limits of x axis
    ylim=(0,maximum(list_energy_resolution)[end]*1.1),                              #limits of y axis
    xticks=[10^exp for exp in (3:0.5:4)],
    yticks=(0.05:0.04:0.15),
    ...
    dpi=500)                                                                                     #resolution for the figure
# Save the figure
file_name = "/home/adan1210/Documents/Proofs/swgo_scripts/swgo_plots/energy_resolution.svg"
savefig(file_name)
